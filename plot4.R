plot4 <- function() {
# Function plots 4 plots to summarise electricity consumption as reported in the 
# UC Irvine power consumption dataset:
...
# Sub figure 1
house_power[,plot(POSIXct_time,Global_active_power,type = "l",xlab = "")]

# Sub figure 2
plot_with_sub_metering(house_power)

# Sub figure 3
house_power[,plot(POSIXct_time,Voltage,type = "l",xlab="")]

# Sub figure 4
house_power[,plot(POSIXct_time,Global_reactive_power,type = "l",xlab = "")]
...
plot_with_sub_metering<- function(house_power){
